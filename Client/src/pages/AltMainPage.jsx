        ...
        <div className="relative px-6 lg:px-8 flex flex-col items-center justify-center h-full text-center">
          <div className="max-w-2xl">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a href="/login" className="rounded-full px-3.5 py-2 text-md bg-white/10 font-medium  text-white shadow-xs hover:bg-white hover:text-black transition duration-500 ease-in-out outline-1 focus-visible:outline-offset-2 focus-visible:outline-gray-600">
